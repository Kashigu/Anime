    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="<?php echo $dadosAnime['animeImagemURL'] ?>">
                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            ...
                            <div class="anime__details__btn">
                                ...
                                ?>
                                <a href="anime-watching.php?id=<?php echo $dadosAnime['animeId'] ?>&episodioId=<?php echo $dadosEpisodios['episodioId'] ?>" class="follow-btn"><span>Watch Now</span> </a>
                                </div>
                            </div>
                        </div>
                    </div>
